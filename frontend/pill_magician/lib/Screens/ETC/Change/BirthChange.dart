...
class BirthChange extends StatelessWidget {
  
  @override
  Widget build(BuildContext context) {
    final TextEditingController _newBirthController = TextEditingController();
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            TextField(
              controller: _newBirthController,
              decoration: InputDecoration(labelText: '새로운 생년월일'),
            ),
            SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
                if (userNum != null) {
                String newBirth = _newBirthController.text;
