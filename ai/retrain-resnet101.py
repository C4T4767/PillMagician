...
def main():
    ...
    #image_datasets
    dataloaders = {x: torch.utils.data.DataLoader(image_datasets[x], batch_size=batch_size, shuffle=True, num_workers=12, pin_memory=True, drop_last=True) for x in ['train', 'val','test']}
