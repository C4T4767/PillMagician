...
router.get('/:folder', isAuthenticated, (req, res) => {
    ...
    const folderPath = path.join(__dirname, '../../log/Admin', folder); // 해당 폴더의 전체 경로
    ...
    fs.readdir(folderPath, (err, files) => {
        ...
        fs.readFile(jsonFilePath, 'utf8', (err, data) => {
            ...
            res.render('cog_log/admin_log_detail', { layout: 'layouts/main_layout', user: req.session.user, jsonData: jsonData, folderPath: folderPath });
        });
    });
});
