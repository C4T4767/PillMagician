...
router.post('/', isAuthenticated, (req, res) => {
    ...
    fs.access(log.subprocessFlagFilePath, fs.constants.F_OK, (err) => {
        if (err) {
            ...
            return res.render('modal2', { message: '현재 실행중인 학습이 없습니다.', message2: '뒤로가기', redirectUrl: '/ai/training', layout: false });
        }
        ...
        fs.readFile(log.subprocessFlagFilePath, 'utf8', (err, pid) => {
            ...
            exec(`kill ${pid}`, (err) => {
                if (err) {
                    ...
                    res.render('modal2', { message: '학습이 중지되었습니다.', message2: '뒤로가기', redirectUrl: '/ai/training', layout: false });
                });
            });
        });
    });
